...
border: 2px solid  #CCC;
  ...
  border: 2px solid  #24C57A;
    color: var(--primary); /* 텍스트 색상 변경 */

    svg path {
      fill: var(--primary); /* SVG 색상 변경 */
      transition: fill 0.3s; /* 부드러운 전환 */
    }
  }
  ...
  svg path {
    fill: #bbbbbb; /* 기본 SVG 색상 */
    transition: fill 0.3s; /* 부드러운 전환 */
  }
`;

export default function GoodButtonWithIcon() {
  return (
    <Goodbtn>
      <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 20">
